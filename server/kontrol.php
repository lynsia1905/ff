...
if (isset($_POST['g-recaptcha-response'])) {
    $email;$comment;$captcha;
        ...
        if(!$captcha){
          echo '<meta name="viewport" content="width=device-width, initial-scale=1"> <meta http-equiv="refresh" content="2;URL=/login/">
<br><br><br><h2 style="font-size:30px;"><center>Lütfen captcha bölümünü kontrol ediniz!</center></h2>';
          exit;
        }
    $secretkey = "6LcNa5QhAAAAAA9P6_HxL3QGvqBAc7hbXq-ZsHoL";
